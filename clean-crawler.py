...
list_of_domain = set();
list_dom = ["sohu.com","instagram.com","vk.com","hao123.com","taobao.com","qq.com","amazon.com","youtube.com","twitter.com","facebook.com","t.com","f.com","google.com", "sina.com.cn"]
for i in list_dom:
...
class crawler:
    ...
    def PhanOut(self,link):
        sets = {}
        try:
            self.color = css_prop(link,'iterBfs','colorOnly');
...
c = crawler();
c.crawl("https://www.quantcast.com/top-sites/US/");